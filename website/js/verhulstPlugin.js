function bifurcation(elmMap, elmBif=null, zoom=false, width=648, height=432, cobwebIterations=200, 
                     x0= 0.1, minR = 1.95, maxR = 3, minX = 0, maxX = 4/3, minY = 0, maxY= 4/3, initialR = 2.5) {
    ...
    if (elmBif != null) {
        ...
        if (zoom) {
            ...
            elmBif.addEventListener('mousemove', function(e){
              mouseUpCoord = new Coord(e.clientX - elmBif.offsetLeft - 2, e.clientY - elmBif.offsetTop);
